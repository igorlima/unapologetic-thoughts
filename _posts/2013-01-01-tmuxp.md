    ...
    - window_name: terminal-reading
      ...
      panes:
        ...
        - shell_command:
          ...
          - pip3 install pudb
          - pip3 install google-genai==1.56.0
          - pip3 install xml2epub==2.6.10
          - pip3 install markdown==3.10
          - python3 gemini-pdf2md.py --help
        - shell_command:
          # to use custom tmux layout: `tmux display-message -p '#{window_layout}'`
